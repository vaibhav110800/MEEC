...
document.getElementById('5').onclick = function changeContent() {
    document.getElementById('courses1').style = "display: none";
    document.getElementById('courses2').style = "display: none";
    document.getElementById('courses3').style = "display: none";
    document.getElementById('courses4').style = "display: none";
...
document.getElementById('6').onclick = function changeContent() {
    document.getElementById('courses1').style = "display: none";
    document.getElementById('courses2').style = "display: none";
    document.getElementById('courses3').style = "display: none";
    document.getElementById('courses4').style = "display: none";
...
document.getElementById('7').onclick = function changeContent() {
    document.getElementById('courses1').style = "display: none";
    document.getElementById('courses2').style = "display: none";
    document.getElementById('courses3').style = "display: none";
    document.getElementById('courses4').style = "display: none";
...
document.getElementById('8').onclick = function changeContent() {
    document.getElementById('courses1').style = "display: none";
    document.getElementById('courses2').style = "display: none";
    document.getElementById('courses3').style = "display: none";
    document.getElementById('courses4').style = "display: none";
